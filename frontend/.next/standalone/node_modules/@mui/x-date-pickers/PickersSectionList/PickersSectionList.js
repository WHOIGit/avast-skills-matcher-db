...
process.env.NODE_ENV !== "production" ? PickersSection.propTypes /* remove-proptypes */ = {
  // ----------------------------- Warning --------------------------------
...
const PickersSectionList = exports.PickersSectionList = /*#__PURE__*/React.forwardRef(function PickersSectionList(inProps, ref) {
  ...
  const getRoot = methodName => {
    if (!rootRef.current) {
      throw new Error(process.env.NODE_ENV !== "production" ? `MUI X: Cannot call sectionListRef.${methodName} before the mount of the component.` : (0, _formatErrorMessage2.default)(145, methodName));
    }
...
process.env.NODE_ENV !== "production" ? PickersSectionList.propTypes /* remove-proptypes */ = {
  // ----------------------------- Warning --------------------------------
  // | These PropTypes are generated from the TypeScript type definitions |
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
